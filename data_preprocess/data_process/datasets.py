...
class SenTagSequence(object):
    def __init__(self, sen_words: List[str], sen_tags_list: List[str]):
    ...
    def convert_to_ids(self, tokenizer: TagTokenizer):
        sen_tag_ids_list = tokenizer.convert_tags_to_ids(self.sen_tags_list)
        return sen_tag_ids_list


class QueryTagSequence(SenTagSequence):
    def __init__(self, query_words, query_tags_list):
